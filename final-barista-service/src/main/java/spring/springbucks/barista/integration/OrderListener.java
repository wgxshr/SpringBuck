package spring.springbucks.barista.integration;

import spring.springbucks.barista.model.CoffeeOrder;
import spring.springbucks.barista.model.OrderState;
import spring.springbucks.barista.repository.CoffeeOrderRepository;
